...
Deep-dive reference for the **Performance axis** of `irega-code-review` (see [axes.md](axes.md#5-performance)). Open this when a change touches hot paths, list endpoints, bundles, or rendering. Loaded on demand — not part of the base review prompt.
