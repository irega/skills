...
Deep-dive reference for the **Accessibility axis** of `irega-code-review` (see [axes.md](axes.md#6-accessibility-frontend)). Open this when a change touches UI markup, components, forms, or interactions. WCAG 2.1 AA baseline. Loaded on demand — not part of the base review prompt.
